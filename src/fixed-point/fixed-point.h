...
struct FixedPoint64 fixed_point_construct(int32_t integer, uint32_t fraction);
struct UFixedPoint64 ufixed_point_construct(uint32_t integer, uint32_t fraction);
